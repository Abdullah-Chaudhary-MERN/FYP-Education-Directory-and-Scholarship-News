...
<html>
    ...
    <style>
      ...
      .card-header{
        background-color: rgb(201, 157, 45);
        color: black;
        font-size: 30px;
      }
      .btn_2 {
...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <a class="nav-link"  href="ContactUs.php">Contact US</a>
      ...
      <?php }?>
          ...
          <div>
            ...
            <br>
            <br>
            <div class="card text-center col-md-8 mx-auto mt-5 ">
  ...
  <div class="card-body">
            ...
            <?php
              include("conn.php");
              $aid=$_GET['aid'];
              $sql="SELECT * FROM `admission form` WHERE `id`='$aid'";
              $res=mysqli_query($conn,$sql);
              $row=mysqli_fetch_assoc($res);
              ?>
              <div class="col-md-6"><br>    <iframe src="upload/<?php echo $row['image'] ?>" width="100%" height="500px">
            </iframe>
        </div>
             
              <div class="col-md-6 "  style="color: black; padding-top: 30px;" ><h5><?php echo $row['fpname'] ?></h5>
                <p><strong>Name</strong>  <?php echo $row['uname'] ?></p>
                <h5><?php echo $row['ayear'] ?></h5>
                <p><?php echo $row['adstart'] ?></p>
                <div class="row">
                  <div class="col-3"></div>
                  <div class="col-3"></div>
                  <div class="col-3"></div>
                  <div class="col-3"> <button type="submit" class="btn btn-success" name="go" style="background-color: darkgreen;opacity: 1.0;">Apply</button></div>
                </div>
                </div>
            </div>
  ...
  <div class="card-footer text-muted col-md-8 mx-auto mb-5">
    2 days ago
  </div>
</div>
    </body>
