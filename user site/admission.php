...
<nav class="navbar navbar-expand-lg fixed-top" >
    ...
    ?>
          <div class="card m-3" style="width:20rem;">
            <img src="../TECHSTEP/upload/<?php echo $row['image']?>" class="card-img-top"  style="height:200px;" alt="..">
            <div class="card-body text-center">
              <a href="" class="card-text"><?php echo $row['fpname']?></a><br>
              <a href="" class="card-text"><?php echo $row['ayear']?></a><br>
              <a href="addmissionform.php?id=<?php echo $row['id']?>" class="btn btn-success mt-1">apply</a>
            </div>
          </div>
          <?php } ?>
