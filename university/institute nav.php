...
<?php
  ...
  <?php }?>
      <br>
      <br>
<form class="col-md-4 mx-auto p-5 ac" action="work.php" method="post" enctype="multipart/form-data">
...
<div class="container text-center">
  <div class="row ">
    ...
    foreach($res as $row){
    ?>
    <div class="card m-3" style="width:18rem;background-color:rgb(226, 226, 226);">
      <img src="uploadfile/<?php echo $row['backimg']; ?>" class="card-img-top bg2" style="height:200px;" alt="..">
      <div class="card-body"  >
        <div class="height:200px;">
        <a class="card-text fw-bold text-black" href="institute.php?id=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a>
       <br>
    </div>
        <a href="deleteinstitute.php?did=<?php echo $row['id'] ?>"class="btn btn-danger">Delete</a>
        <a href="editinstitute.php?eid=<?php echo $row['id'] ?>"class="btn btn-primary">Edit</a>
  ...
  <div class="row p-3">
    ...
    <div class="col-md-4">
      ...
      <ul class="fot2"style="list-style:none;">
       <a class="fot1" href="institute nav.php"> <li class="mt-2">
          Institute
        </li></a>
