 ...
 <style>
  ...
  <li class="nav-item">
    <a class="nav-link"  href="ContactUs.php">Contact US</a>
      ...
      <?php }?>
  <Form class="col-md-6 mx-auto  p-3 was-validated" style="margin-top: 100px;" action="" method="post" enctype="multipart/form-data" >
      <h1 >Focal Person Login</h1>
  ...
  <br>
  <div class="row">
  <div class="col-3"><a class="cna" href="register.php">Create New Account</a></div>
  <div class="col-3"></div>
  <div class="col-3 "></div>
  <div class="col-3 "><button type="submit" name="Login" class="btn_2" style="background-color: #F3AD24;">Login</button></div>
 </div>
    </Form>
    <br>
    <br>
