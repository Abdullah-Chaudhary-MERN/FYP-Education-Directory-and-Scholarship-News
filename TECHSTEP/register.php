...
<nav class="navbar navbar-expand-lg fixed-top">
 ...
 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <Form class="col-6 mx-auto p-3 mt-5 was-validated" action="phpwork.php" method="post" enctype="multipart/form-data">
      <br>
      <br>
      <h1 class="abc">Focal Person Registration</h1>
 <label class="form-label" style="color: white" >
    First and Last Name
 </label class=" form-label" >
 <input type="name" class="form-control" name="flname" placeholder="Enter Your Full Name" pattern="[A-Z,a-z ]{3,}" required>
 ...
 <input type="ID" class="form-control" name="cnic" placeholder="Enter your CNIC number" required pattern="[0-9]{5}-[0-9]{7}-[0-9]{1}" >
 <div class="invalid-feedback">
      Please enter a CNIC.
    </div>
 <label class="form-label">
   ...
   <input type="date" class="form-control" name="dob" required pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}" >
   <div class="invalid-feedback">
 ...
 <textarea class="form-control" name="address" required pattern="[A-Z, a-z ]{3,}"></textarea>
 <div class="invalid-feedback">
 ...
 <label class="form-label">
   ...
   <select name="uname" class="form-select" required>
     <?php 
     include('conn.php');
 ...
 <input type="Email" class="form-control" name="uemail" placeholder="Enter Your University Email" required>
 <div class="invalid-feedback">
 ...
 '<input type="text" class="form-control"name="ucontact" placeholder="Enter Your Contact" required pattern="[0-9]{4}-[0-9]{7}">
 <div class="invalid-feedback">
 ...
 <input type="email" class="form-control"name="email" placeholder="Enter Your Personal Email" required>
 <div class="invalid-feedback">
 ...
 <input type="text" class="form-control"placeholder="Enter Your Designation" name="designation" required pattern="[A-Z ,a-z ]{3,}" >
 <div class="invalid-feedback">
 ...
 <input type="text" class="form-control"placeholder="Enter Your University Card No" name="ucard" required pattern="[0-9]{5}-[0-9]{7}-[0-9]{1}">
 <div class="invalid-feedback">
   Please Enter a correct Univeristy Card .
 </div>
 <label class="form-label">
     Upload Profile Picture
 </label>
 <input type="file" class="form-control" name="uprofilepic" required>
 <div class="invalid-feedback">
 ...
 <div class="col-3 "></div>
 <div class="col-3 ">
  <button type="submit" name="send1" class="btn_2" style="background-color: #F3AD24;">Register</button>
</div>
