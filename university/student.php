...
<?php
    ...
    <?php
      ...
      <tr>
        ...
        <td>
            ...
            <a href="deletestudent.php?did=<?php echo $ow['id'];?>" type="submit" class="btn btn-success">Delete</a>
  ...
  <br>
  <br>
  <footer class="container-fluid fixed-bottom" style="background-color:rgb(26, 25, 25) ;">
    <div class="row p-3">
