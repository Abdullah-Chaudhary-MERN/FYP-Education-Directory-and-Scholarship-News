...
<nav class="navbar navbar-expand-lg fixed-top">
  ...
  <li class="nav-item">
    ...
    <Form class="col-6 mx-auto p-3 mt-5 was-validated" action="phpwork.php" method="post" enctype="multipart/form-data" id="add">
      <h1 class="abc">Add Admission Form</h1>
        ...
        <input type="hidden" class="form-control" name="fpname" placeholder="Enter Your Name" required pattern="[A-Z,a-z, ]{3,}"  value="<?php echo $fname;?>">
        <br>
        ...
        <label class="form-label" style="color: white" >
         ...
         <input type="text" class="form-control" name="uname" placeholder="Enter Your University Name" required pattern="[A-Z,a-z, ]{3,}" >
         <div class="invalid-feedback">
         ...
         <input type="year" class="form-control" name="ayear" required pattern="[0-9]{4}">
         <div class="invalid-feedback">
        ...
        <label class="form-label" style="color: white" >
         ...
         <input type="date" class="form-control" name="adstart" required pattern="[0-9]{2}[0-9]{2}[0-9]{4}">
         <div class="invalid-feedback">
        ...
        <label class="form-label" style="color: white" >
         ...
         <input type="date" class="form-control" name="adend" required pattern="[0-9]{2}[0-9]{2}[0-9]{4}">
         <div class="invalid-feedback">
        ...
        <div class="row">
        <div class="col-5 "></div>
        <div class="col-5 "><button type="submit" name="send"class="btn_2" style="background-color: #F3AD24;">Submit</button></div>
        </div>
       </div>
    </Form>
    <div>
    ...
    <?php  ?>
    <div class="container crd" style="margin-top: 50px;" id="admission">
      <div class="row" style="padding-left:40px ;">
      <?php
      include('conn.php');
      $sql="SELECT * FROM `admission form`";
      ...
      ?>
        <div class="card m-3" style="width: 20rem;">
          <a></a>
          <div class="card-body">
            <a class="card-text" href="admissiondetails.php?aid=<?php echo $row['id']?>"><?php echo $row['uname']?></a><br>
            <a href="studentdata.php?did=<?php echo $row['id']?>" class=" btn_2"  style="background-color: #F3AD24;">check</a>
            <a href="deleteadmission.php?did=<?php echo $row['id']?>" class="btn_2"  style="background-color: red;">Delete</a>
            <a href="Edit.php?eid=<?php echo $row['id']?>"class="btn_2" style="background-color: green;">Edit</a>
          </div>
        </div>
        <?php }?>
        </div>
