  ...
  <div class="container text-center">
    <div class="row ">
      <div class="card m-3" style="width:20rem;">
        <a href="institute nav.php"> <img src="arid.jfif" class="card-img-top" style="height:200px;" alt=".."></a>
        <div class="card-body">
          <a class="card-text fw-bold" href="institute nav.php">Institute</a>
        </div>
      </div>
      <div class="card m-3" style="width: 20rem;">
        <a href="scholarship.php"> <img src="scholarship 456.jpg" class="card-img-top" style="height:200px;"
            alt="..."></a>
        <div class="card-body">
          <a class="card-text fw-bold" href="scholarship.php">Scholarships</a>
        </div>
      </div>
      <div class="card m-3" style="width: 20rem;">
        <a href="institute nav.php"><img src="Pir-Mehr-Ali-Shah-Arid-University.jpg" class="card-img-top"
            style="height:200px;" alt="..."></a>
        <div class="card-body">
          <a href="institute nav.php" class="card-text fw-bold">Add university</a>
        </div>
      </div>
      <div class="card m-3" style="width: 20rem;">
        <a href="user.php" href="user.php"><img src="user12.png" class="card-img-top" style="height:200px;"
            alt="..."></a>
        <div class="card-body ">
          <a class="card-text fw-bold" href="user.php">User</a>
        </div>
      </div>
      <div class="card m-3" style="width: 20rem;">
        <a href="focal.php"><img src="FocalPerson.png" class="card-img-top" style="height:200px;" alt="..."></a>
        <div class="card-body">
          <a class="card-text fw-bold" href="focal.php">Focal person</a>
        </div>
      </div>
      <div class="card m-3" style="width: 20rem;">
        <a href="contact us .php"><img src="contact us.jpg" class="card-img-top" style="height:200px;" alt="..."></a>
        <div class="card-body">
          <a class="card-text fw-bold " href="contact us .php">Contact Us</a>
        </div>
      </div>
    </div>
  </div>
...
<footer class="container-fluid" style="background-color:rgb(26, 25, 25) ;">
  <div class="row p-3">
    ...
    <div class="col-md-4">
      <a href=""><img src="logo 75.png" style="height: 150px;margin-left:130px ;" ></a>
