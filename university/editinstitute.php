...
<?php
$eid=$_GET['eid'];
$sql="SELECT * FROM `instute` WHERE `id`='$eid'";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_assoc($result);
?>
<form class="col-md-4 mx-auto p-5 ac" action="work.php?eid=<?php echo $row['id']?>" method="post" enctype="multipart/form-data">
  <h1 style="color:white ;">Edit University</h1> 
  <label class="form-label">Name</label>
  <input class="form-control" type="text" required name="name" value="<?php echo $row['name'] ?>">
  <label class="form-label">sub campus</label>
  <input class="form-control" type="text" required name="subcam" value="<?php echo $row['subcam'] ?>">
  <label class="form-label">Main campus</label>
  <input class="form-control" type="text" required name="maincam" value="<?php echo $row['maincam'] ?>">
  <label class="form-label">Director Name</label>
  <input class="form-control" type="text" required name="directorname" value="<?php echo $row['directorcam'] ?>">
  <label class="form-label">phone no</label>
  <input class="form-control" type="number" required name="directorname" value="<?php echo $row['directorcam'] ?>">
  <label class="form-label">phone no</label>
  <input class="form-control" type="text" required name="phoneno" value="<?php echo $row['phoneno'] ?>">
  <label class="form-label">Address</label>
  <input class="form-control" type="text" required name="address" value="<?php echo $row['address'] ?>">
  <label class="form-label">website link <link rel="stylesheet" href=""></label>
  <input class="form-control" type="link" required name="link" value="<?php echo $row['link'] ?>">
  <label class="form-label">background-image</label>
  <input class="form-control" type="file" required name="backimg" value="<?php echo $row['backimg'] ?>">
  ...
  <div class="col-4"></div>
  <div class="col-2"> <button type="submit" class="btn btn-success" name="editinstitute" style="background-color:rgb(8, 129, 28);opacity:1.0;">send</button></div>
  </div>
</form>
