...
<div>
  ...
  <form class="col-md-6 mx-auto p-3 mt-5 firm" action="../user site/work.php" method="post" enctype="multipart/form-data" style="margin-top: 120px; ">
    <h1 class="abc">Add Scholarships</h1>
   ...
   <input type="text" class="form-control" name="title" placeholder="Enter your title " >
    ...
    <label class="form-label" style="color: white;">
      ...
      <textarea class="form-control" name="detail" placeholder="Enter Detail" rows="6"></textarea>
   <label class="form-label" style="color: white;">
    Description 2
   </label>
   <br>
...
<input type="text" class="form-control" name="title1" placeholder="Enter your titel">
  <label class="form-label" style="color: white;">
    Details
 </Label>
 <textarea class="form-control" name="detail1" placeholder="Enter Detail" rows="8"></textarea>
 <label class="form-label" style="color: white" >
  Scholarship Apply Link
</label>
<input type="text" class="form-control" name="scdate" >
<label class="form-label" style="color: white" >
  Scholarship Date End
</label>
<input type="date" class="form-control" name="scend" >
<label class="form-label" style="color: white;">
  Upload image 
  </label>
   <input type="file" class="form-control" name="upload" placeholder="Upload The Picture" >
   <br>
   <div class="row">
   <div class="col-4 "></div>
   <div class="col-4 "></div>
   <div class="col-4 "><button type="submit" name="institute2" class="btn btn-primary">submit</button></div>
  ...
  <div class="row mx-auto">
    ...
    <div class="card m-3" style="width:20rem;">
      ...
      <div class="card-body text-center">
        ...
        <a href="scolarshipdetail.php?sid=<?php echo $row['id']; ?>" class="btn btn-success mt-1">View</a>
      </div>
    </div>
    <?php } ?>
  </div>
