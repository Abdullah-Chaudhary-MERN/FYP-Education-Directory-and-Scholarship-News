...
<html>
 ...
 transform: 0.8s;
    ...
    <body style="background-image:url(999.jpg) ; background-size: cover;">
    <?php
 session_start();
 include('conn.php');
...
<nav class="navbar navbar-expand-lg fixed-top">
 ...
 <h1 class="abc">Contact Us</h1>
 <label class="form-label" style="color: white" >
   Name
 </label class=" form-label">
 <input type="text" class="form-control" placeholder="Enter Your Name" name="fname" pattern="[A-Z,a-z]{3,}" required>
 ...
 <input type="text" class="form-control"placeholder="Enter Your Subject" name="subject" required pattern="[A-Z,a-z]{3,}"  >
 <div class="invalid-feedback">
 ...
 <textarea class="form-control" name="subject2" required ></textarea>
 <br>
 ...
 <div class="col-3"></div>
 <div class="col-3 "></div>
 <div class="col-3 "><a type="submit"class="btn_2" style="background-color: #F3AD24;" name="contact">Submit</a></div>
 </div>
    </Form>
    <br>
    <br>
