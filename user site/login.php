...
background-color:rgb(23, 184, 170);
    ...
    <div>
        <form class="col-6 mx-auto p-3 mt-5 firm needs-validation" action="" method="post" enctype="multipart/form-data"novalidate> 
          <h1>User login form</h1>
          <b>
            <label class="form-label" >
                Email
            </label>
            <input type="Email" class="form-control" placeholder="Enter Email" id="validationCustom01" required name="ename">
            ...
            <input type="password" class="form-control" placeholder="Enter Pasward" id="validationCustom01" required name="pname">
            <div class="invalid-feedback">
              please enter Password
            </div>
            <br>
            <div class="row">
            <div class="col-6"><a href="sign.php" style="direction: none;color:aliceblue">Creat New</a></div>
            </div>
          
           <BR>
                <button type="submit" class=" btn btn-success" name="login">send</button>
...
<footer class="container-fluid" style="background-color:rgb(23, 184, 170) ;">
  <div class="row p-3">
    ...
    <div class="col-md-4">
      ...
      <h3 class="text-center" style="margin-top:5px ; color: black;margin-left: 40px;">Contact US</h3>
