...
<div>
  ...
  <?php
    ...
    ?>
    <div class="col-md-6"><br><img src="../university/uploadfile/<?php echo $row['upload'] ?>" alt="" style="border-radius: 5px; height: 400px; width: 500px; padding-left: 30px;padding-bottom: 30px;" ></div>
    ...
    <div class="col-md-6 "  style="color: black; padding-top: 30px;" ><h5><?php echo $row['title'] ?></h5>
      ...
      <div class="row">
        ...
        <div class="col-3"></div>
        <div class="col-3"></div>
        <div class="col-3"> <a href="<?php echo $row['scdate'] ?>" class="btn btn-success" name="go" style="background-color: darkgreen;opacity: 1.0;">Apply</a></div>
      </div>
      </div>
  </div>
